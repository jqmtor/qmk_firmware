...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   `  |   ,  |   .  |  /   |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Ctrl |  Alt |  GUI |Layer1| Bksp |    Space    |Enter |Layer2|   =  |   [  |  ]   |
     * `-----------------------------------------------------------------------------------'
     */
    [0] = LAYOUT_planck_mit(
        KC_ESC,  KC_Q,    KC_W,    KC_E,  KC_R,    KC_T,   KC_Y,   KC_U,  KC_I,   KC_O,    KC_P,    KC_MINS,
        KC_TAB,  KC_A,    KC_S,    KC_D,  KC_F,    KC_G,   KC_H,   KC_J,  KC_K,   KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,  KC_V,    KC_B,   KC_N,   KC_M,  KC_GRV, KC_COMM, KC_DOT,   KC_SLSH,
        KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_BSPC, KC_SPC,         KC_ENT, MO(2), KC_EQL,  KC_LBRC, KC_RBRC
    ),
